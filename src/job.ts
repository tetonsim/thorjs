...
export class Material {
  ...
  constructor(
    ...
    this.density = density ? density : 1
    this.elastic = elastic ? elastic : {
      type: 'isotropic',
      E: 1,
      nu: 1,
    }
    this.fracture = fracture ? fracture : { KIc: 1 }
    this.failure_yield = failure_yield ? failure_yield : { type: 'von_mises', Sy: 1 }
...
export class Extruder {
  ...
  constructor(number?: number, usable_material?: Array<string>) {
    ...
    this.usable_material = usable_material ? usable_material : ['defatult']
  }
}
...
export class SmartSliceJob implements Job {
  public type: string;
  chop: Model;
  bulk: Material[];
  extruders: Extruder[];
